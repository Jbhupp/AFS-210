...
playlist.addSong(Song('George Jones', 'Choices'))
playlist.addSong(Song('Eric Church', 'Springsteen'))
playlist.addSong(Song('George Jones', 'He Stopped Loving Her Today'))
playlist.addSong(Song('Dolly Parton', '9 to 5'))
playlist.addSong(Song('Kid Rock', 'Cowboy'))
playlist.addSong(Song('George Jones', 'White Lightning'))
